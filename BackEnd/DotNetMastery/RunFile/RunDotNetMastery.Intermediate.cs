using DotNetMastery.CommonUtils.Models;
using DotNetMastery.Intermediate.Collections;
using DotNetMastery.Intermediate.Delegates;
using DotNetMastery.Intermediate.ExtensionMethod;
using DotNetMastery.Intermediate.LinQ;

namespace DotNetMastery.RunFile
{
    public static class RunDotNetMasteryIntermediate
    {
        ...
        public static void RunDelegatesAndEvents()
        {
            ...
            DotNetMastery.Intermediate.Delegates.MulticastDelegate.RunMulticastDelegate();
