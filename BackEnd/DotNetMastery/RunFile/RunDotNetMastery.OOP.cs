using DotNetMastery.ExpertPatterns.SolidPrinciple;
using DotNetMastery.OOP.CorePillars;
using static DotNetMastery.OOP.Contracts.InterfaceVsAbstract;
using static DotNetMastery.OOP.CorePillars.Interface;

namespace DotNetMastery.RunFile
{
    public static class RunDotNetMasteryOOP
    {
